...
<form action="adminController" method="get">
  <div class="form-group">
    <label>Mã sách</label>
    <input type="text" class="form-control" placeholder="maloai" name="maloai"value="<%=sc!=null?sc.getMasach():""%>">
  </div>
  <div class="form-group">
    <label>Tên sách</label>
    <input type="text" class="form-control" placeholder="tenloai" name="tenloai" value="<%=sc!=null?sc.getTensach():""%>">
  </div>
...
<div class="card card-body mt-10">
   ...
   <table class="table table-striped table-hover">
         ...
         <tr>
           ...
           <td><%=sb.getTacgia()%></td>
           <td>
           		<a class="btn btn-info" href="adminController?mlChon=<%=sb.getMasach()%>">Chọn</a> 
           		<a class="btn btn-danger" href="adminController?mlXoa=<%=sb.getMasach()%>">Xóa</a>
           	</td>
         </tr>
